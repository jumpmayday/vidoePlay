# -*- coding: utf-8 -*-
"""Update models, scanner, repository for proper folder grouping."""
from pathlib import Path

ROOT = Path(r"D:\code\stu\videoPlay")

# --- VideoModels.kt ---
(ROOT / "app/src/main/java/com/localplay/app/data/model/VideoModels.kt").write_text(
...
# --- VideoScanner.kt ---
(ROOT / "app/src/main/java/com/localplay/app/core/scanner/VideoScanner.kt").write_text(
    r'''package com.localplay.app.core.scanner
